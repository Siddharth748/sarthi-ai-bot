// index.js — SarathiAI (v5.1 - Debugging OpenAI Embedding Error)
...
/* ---------------- Startup logs ---------------- */
console.log("\n🚀", BOT_NAME, "starting with detailed error logging...");
...
// ✅ MODIFIED FUNCTION WITH DETAILED ERROR LOGGING
async function openaiEmbedding(textOrArray) {
  ...
  try {
    ...
    return null; // Return null to trigger our existing error message
  }
}
